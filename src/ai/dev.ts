...
// Sadece üzerinde çalıştığımız motivasyon mesajı akışını import et
import '@/ai/flows/ai-motivational-message.ts';
// import '@/ai/flows/ai-assisted-descriptions.ts'; // Şimdilik yorum satırında kalsın
// import '@/ai/flows/weather-forecast-flow.ts'; // Artık kullanılmıyor, WelcomeMessage'da doğrudan çağrılıyor
